...
Solid *CreateC()
{
    ...
    Vertex *P2 = H2->endV;
    HalfEdge *H3 = mev(P2, Point(-1.0, 0.5, -0.5), topLoop);
    Vertex *P3 = H3->endV;
    HalfEdge *H4 = mev(P3, Point(-1.0, 0.5, 0.25), topLoop);
    Vertex *P4 = H4->endV;
    HalfEdge *H5 = mev(P4, Point(0.25, 0.5, 0.25), topLoop);
    Vertex *P5 = H5->endV;
    HalfEdge *H6 = mev(P5, Point(0.25, 0.5, 1.25), topLoop);
    Vertex *P6 = H6->endV;
    HalfEdge *H7 = mev(P6, Point(-1.0, 0.5, 1.25), topLoop);
    Vertex *P7 = H7->endV;

    Loop *downLoop = mef(P0, P7, topLoop);
